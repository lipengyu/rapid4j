...
// });
    ...
    expect(data.getText()).toMatch('Request failed');
        ...
        function $http(requestConfig) {
          ...
          if(isUndefined(requestConfig.async)) requestConfig.async = true;
          var config = extend({
            method: 'get',
            transformRequest: defaults.transformRequest,
            transformResponse: defaults.transformResponse
          }, requestConfig);
          if(isUndefined(requestConfig.async)){
            config.async = true;
          }else{
            config.async = requestConfig.async;
          }
          ...
          if(!config.async)  {
            ...
            // send request
            var promise = sendReq(config, reqData).then(transformResponse, transformResponse);
        ...
        function sendReq(config, reqData) {
          ...
          if(isUndefined( config.async))   config.async = true;
          ...
          if (isUndefined(cachedResp)) {
            ...
            $httpBackend(config.method, url, reqData, done, reqHeaders, config.timeout,
                config.withCredentials, config.responseType,config.async);
          }
